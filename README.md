...
<h4 align="left">In this project, to detect whether a person is wearing a mask or not mask. Incase, person is not wearing mask system will give alert sound with text as well as it will show the confidence value of the prediction.</h4>
